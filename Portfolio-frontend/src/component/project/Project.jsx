...
import goldentable from "../../assets/images/goldentable.png"
...
const projects =[
  ...
  { Img: `${goldentable}`, title: 'The Golden Table', description: 'The Golden Table is a full-stack restaurant table booking system built with Django, Django REST Framework, and React.js. It includes authentication (JWT), role-based access, table booking management, OTP verification, and real-time booking workflows.', link:"https://github.com/Lakshit-Poojari/The-Golden-Table"},
