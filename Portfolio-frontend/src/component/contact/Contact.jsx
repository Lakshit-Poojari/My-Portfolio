          ...
          <div className="d-flex justify-content-center text-center col-12 col-lg-6 mt-5">
            <div className="form">
              <form onSubmit={handleSubmit}>
                ...
                ></textarea>
                <br />
                <button type="submit" className="send btn text-center mt-2">
                  SEND
                </button>
              </form>
            </div>
          ...
          <div className="contact_detail col-12 col-lg-6 mt-5">
            <div>
              <div className="contact-text justify-content-center">
                <p>
                  I'm always open to connecting, collaborating, or discussing
                  new opportunities. Feel free to reach out through any of the
                  following:
                </p>
              </div>
              <div className=" contact_method mt-3">
                <a href="tel:9869620509">
                  <i className="fa-solid fa-phone f-left"></i>: +91-9869620509
                </a>
              </div>

              <div className="contact_method mt-3">
                <a
                  href="https://www.linkedin.com/in/lakshit-poojari/"
                  target="_blank"
              ...
              <div className="contact_method mt-3 ">
                <a
                  href="https://github.com/Lakshit-Poojari"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <div className="contact_method mt-3 ">
                <a
                  href="https://mail.google.com/mail/?view=cm&fs=1&to=lakshitp.2110@gmail.com"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <i className="fa-solid fa-envelope"></i>:
                  lakshitp.2110@gmail.com
                </a>
              </div>

              <div className="mt-5 contact-text">
                <p>
                  Or, simply fill out the form to send me a direct message —
                  just enter your name, email, phone number, and your message.
              ...
              <div className="">
                <a
                  href="https://drive.google.com/drive/folders/18IT-MYNnqDoeFrEN-a0JgeRshqkNrUzh"
                  target="_blank"
                  rel="noopener noreferrer"
                >
